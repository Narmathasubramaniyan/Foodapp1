...
import 'package:foodapp1/Screen/signup.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void loginUser() async {
    ...
    await Future.delayed(const Duration(seconds: 1)); // Simulating login delay
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                height: height / 2.7,
                child: Image.asset(
                    'images/login.jpg'), // Replace with your image asset
              ),
              TextFieldInput(
                icon: Icons.person,
